...
class Projects extends Component
{
    ...
    public $images, $labels, $scripts, $featureSpecific_firmware, $latest_firmware;
    ...
    public function render()
    {
        ...
        $this->featureSpecific_firmware = Firmware::allOfChannel('feature-specific');
        $this->latest_firmware = Firmware::allOfChannel('latest');
